...
//  func build(withListener listener: YearListener) -> YearRouting
// }
//
// final class YearBuilder: Builder<EmptyDependency>, YearBuildable {
//  func build(withListener listener: YearListener) -> YearRouting {
//    let viewController = YearViewController()
//    let interactor = YearInteractor(presenter: viewController)
//    interactor.listener = listener
//    return YearRouter(interactor: interactor, viewController: viewController)
//  }
// }
//
...
//
//  override init(presenter: YearPresentable) {
...
//  var router: YearRouting? { get set }
//  var listener: YearListener? { get set }
// }
//
// protocol YearRouting: ViewableRouting {}
//
// final class YearRouter: ViewableRouter<YearInteractable, YearViewControllable>, YearRouting {
//  override init(interactor: YearInteractable, viewController: YearViewControllable) {
...
//
// final class YearViewController: TracksViewController, YearPresentable, YearViewControllable {
